...
**Note:** this is a heritage version of the buffer manager for projects who want a less fragmented implementation subject to the following caveates:

1. This is an enforced FIFO implementation.  Every allocation must be deallocated in the **same** order.  That is first allocation out is first deallocation in.
