...
#ifndef LLCOMMANDDISPATCHERIMPL_HPP_
#define LLCOMMANDDISPATCHERIMPL_HPP_

#include <LLProc/LLCmdDispatcher/LLCmdDispatcherComponentAc.hpp>
#include <Os/Mutex.hpp>
#include <LLProc/LLCmdDispatcher/LLCmdDispatcherImplCfg.hpp>

namespace LLProc {

    //! \class LLCmdDispatcherImpl
    ...
    class LLCmdDispatcherImpl : public LLCmdDispatcherComponentBase {
        public:
            ...
            LLCmdDispatcherImpl(const char* name);
#else
            LLCmdDispatcherImpl();
#endif
        ...
        PRIVATE:
            ...
            } m_entryTable[LLCMD_DISPATCHER_DISPATCH_TABLE_SIZE]; //!< table of dispatch entries
            ...
            } m_sequenceTracker[LLCMD_DISPATCHER_SEQUENCER_TABLE_SIZE]; //!< sequence tracking port for command completions;
