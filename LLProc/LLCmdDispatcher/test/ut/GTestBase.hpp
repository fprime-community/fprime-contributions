// ======================================================================
// \title  LLCmdDispatcher/test/ut/GTestBase.hpp
// \author Auto-generated
// \brief  hpp file for LLCmdDispatcher component Google Test harness base class
//
// \copyright
...
#ifndef LLCmdDispatcher_GTEST_BASE_HPP
#define LLCmdDispatcher_GTEST_BASE_HPP
...
namespace LLProc {
  ...
  //! \class LLCmdDispatcherGTestBase
  //! \brief Auto-generated base class for LLCmdDispatcher component Google Test harness
  //!
  class LLCmdDispatcherGTestBase :
    public LLCmdDispatcherTesterBase
  {
    ...
    protected:
      ...
      //! Construct object LLCmdDispatcherGTestBase
      //!
      LLCmdDispatcherGTestBase(
      ...
      //! Destroy object LLCmdDispatcherGTestBase
      //!
      virtual ~LLCmdDispatcherGTestBase(void);
