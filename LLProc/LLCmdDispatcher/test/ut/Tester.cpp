...
namespace LLProc {
    ...
    void LLCmdDispatcherImplTester::init(NATIVE_INT_TYPE instance) {
        LLCmdDispatcherGTestBase::init();
    }

    LLCmdDispatcherImplTester::LLCmdDispatcherImplTester(LLProc::LLCmdDispatcherImpl& inst) :
        LLCmdDispatcherGTestBase("testerbase",100),
        m_impl(inst) {
    }

    LLCmdDispatcherImplTester::~LLCmdDispatcherImplTester() {
    }

    void LLCmdDispatcherImplTester::from_compCmdSend_handler(NATIVE_INT_TYPE portNum, FwOpcodeType opCode, U32 cmdSeq, Fw::CmdArgBuffer &args) {
    ...
    void LLCmdDispatcherImplTester::from_seqCmdStatus_handler(NATIVE_INT_TYPE portNum, FwOpcodeType opCode, U32 cmdSeq, Fw::CommandResponse response) {
    ...
    void LLCmdDispatcherImplTester::runNominalDispatch(void) {
        ...
        ASSERT_EQ(this->m_impl.m_entryTable[0].opcode,LLCmdDispatcherImpl::OPCODE_CMD_NO_OP);
        ASSERT_EQ(this->m_impl.m_entryTable[0].port,1);

        ASSERT_TRUE(this->m_impl.m_entryTable[1].used);
        ASSERT_EQ(this->m_impl.m_entryTable[1].opcode,LLCmdDispatcherImpl::OPCODE_CMD_NO_OP_STRING);
        ASSERT_EQ(this->m_impl.m_entryTable[1].port,1);

        ASSERT_TRUE(this->m_impl.m_entryTable[2].used);
        ASSERT_EQ(this->m_impl.m_entryTable[2].opcode,LLCmdDispatcherImpl::OPCODE_CMD_TEST_CMD_1);
        ASSERT_EQ(this->m_impl.m_entryTable[2].port,1);

        ASSERT_TRUE(this->m_impl.m_entryTable[3].used);
        ASSERT_EQ(this->m_impl.m_entryTable[3].opcode,LLCmdDispatcherImpl::OPCODE_CMD_CLEAR_TRACKING);
        ...
        ASSERT_EVENTS_OpCodeRegistered(0,LLCmdDispatcherImpl::OPCODE_CMD_NO_OP,1,0);
        ASSERT_EVENTS_OpCodeRegistered(1,LLCmdDispatcherImpl::OPCODE_CMD_NO_OP_STRING,1,1);
        ASSERT_EVENTS_OpCodeRegistered(2,LLCmdDispatcherImpl::OPCODE_CMD_TEST_CMD_1,1,2);
        ASSERT_EVENTS_OpCodeRegistered(3,LLCmdDispatcherImpl::OPCODE_CMD_CLEAR_TRACKING,1,3);
    ...
    void LLCmdDispatcherImplTester::runNopCommands(void) {
        ...
        Fw::ComBuffer buff;
        ASSERT_EQ(buff.serialize(FwPacketDescriptorType(Fw::ComPacket::FW_PACKET_COMMAND)),Fw::FW_SERIALIZE_OK);
        ASSERT_EQ(buff.serialize((FwOpcodeType)LLCmdDispatcherImpl::OPCODE_CMD_NO_OP),Fw::FW_SERIALIZE_OK);
        ...
        ASSERT_EVENTS_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched(0,LLCmdDispatcherImpl::OPCODE_CMD_NO_OP,1);

        // Verify status passed back to port
        ASSERT_TRUE(this->m_seqStatusRcvd);
        ASSERT_EQ(LLCmdDispatcherImpl::OPCODE_CMD_NO_OP,this->m_seqStatusOpCode);
        ...
        buff.resetSer();
        ASSERT_EQ(buff.serialize(FwPacketDescriptorType(Fw::ComPacket::FW_PACKET_COMMAND)),Fw::FW_SERIALIZE_OK);
        ASSERT_EQ(buff.serialize((FwOpcodeType)LLCmdDispatcherImpl::OPCODE_CMD_NO_OP_STRING),Fw::FW_SERIALIZE_OK);
        // serialize arg1
        ...
        ASSERT_EVENTS_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched(0,LLCmdDispatcherImpl::OPCODE_CMD_NO_OP_STRING,1);

        // Verify status passed back to port
        ASSERT_TRUE(this->m_seqStatusRcvd);
        ASSERT_EQ(LLCmdDispatcherImpl::OPCODE_CMD_NO_OP_STRING,this->m_seqStatusOpCode);
        ...
        buff.resetSer();
        ASSERT_EQ(buff.serialize(FwPacketDescriptorType(Fw::ComPacket::FW_PACKET_COMMAND)),Fw::FW_SERIALIZE_OK);
        ASSERT_EQ(buff.serialize((FwOpcodeType)LLCmdDispatcherImpl::OPCODE_CMD_TEST_CMD_1),Fw::FW_SERIALIZE_OK);
        // serialize arg1
        ...
        ASSERT_EVENTS_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched(0,LLCmdDispatcherImpl::OPCODE_CMD_TEST_CMD_1,1);

        // Verify status passed back to port
        ASSERT_TRUE(this->m_seqStatusRcvd);
        ASSERT_EQ(LLCmdDispatcherImpl::OPCODE_CMD_TEST_CMD_1,this->m_seqStatusOpCode);
        ASSERT_EQ((U32)14,this->m_seqStatusCmdSeq);
        ASSERT_EQ(this->m_seqStatusCmdResponse,Fw::COMMAND_OK);
    }

    void LLCmdDispatcherImplTester::runInvalidOpcodeDispatch(void) {
    ...
    void LLCmdDispatcherImplTester::runFailedCommand(void) {
        ...
        ASSERT_EVENTS_OpCodeError(0,(U32)testOpCode, LLCmdDispatcherComponentBase::ERR_EXECUTION_ERROR);
        ...
        ASSERT_EVENTS_SIZE(1);
        ASSERT_EVENTS_OpCodeError_SIZE(1);
        ASSERT_EVENTS_OpCodeError(0,(U32)testOpCode,LLCmdDispatcherComponentBase::ERR_INVALID_OPCODE);
        ...
        ASSERT_EVENTS_SIZE(1);
        ASSERT_EVENTS_OpCodeError_SIZE(1);
        ASSERT_EVENTS_OpCodeError(0,(U32)testOpCode,LLCmdDispatcherComponentBase::ERR_VALIDATION_ERROR);
    ...
    void LLCmdDispatcherImplTester::runInvalidCommand(void) {
        // verify dispatch table is empty
        for (NATIVE_UINT_TYPE entry = 0; entry < FW_NUM_ARRAY_ELEMENTS(this->m_impl.m_entryTable); entry++) {
            ASSERT_TRUE(this->m_impl.m_entryTable[entry].used == false);
        }
        ...
        ASSERT_EVENTS_MalformedCommand(0,LLCmdDispatcherComponentBase::ERR_TYPE_MISMATCH);

    }

    void LLCmdDispatcherImplTester::runOverflowCommands(void) {
        ...
        for (NATIVE_UINT_TYPE disp = 0; disp < LLCMD_DISPATCHER_SEQUENCER_TABLE_SIZE + 1; disp++) {
            // dispatch a test command
            U32 testCmdArg = 100;
            U32 testContext = 13;
            this->clearEvents();
            ...
            if (disp < LLCMD_DISPATCHER_SEQUENCER_TABLE_SIZE) {
                // verify dispatch event
                ASSERT_EVENTS_SIZE(1);
                ASSERT_EVENTS_OpCodeDispatched_SIZE(1);
                ASSERT_EVENTS_OpCodeDispatched(0,(U32)testOpCode,0);
    ...
    void LLCmdDispatcherImplTester::runClearCommandTracking(void) {
        ...
        buff.resetSer();
        ASSERT_EQ(buff.serialize(FwPacketDescriptorType(Fw::ComPacket::FW_PACKET_COMMAND)),Fw::FW_SERIALIZE_OK);
        ASSERT_EQ(buff.serialize((FwOpcodeType)LLCmdDispatcherImpl::OPCODE_CMD_CLEAR_TRACKING),Fw::FW_SERIALIZE_OK);
        ...
        ASSERT_EVENTS_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched_SIZE(1);
        ASSERT_EVENTS_OpCodeDispatched(0,LLCmdDispatcherImpl::OPCODE_CMD_CLEAR_TRACKING,1);
