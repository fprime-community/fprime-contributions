// ======================================================================
// \title  LLCmdDispatcher/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for LLCmdDispatcher component test harness base class
//
// \copyright
...
#ifndef LLCmdDispatcher_TESTER_BASE_HPP
#define LLCmdDispatcher_TESTER_BASE_HPP

#include <LLProc/LLCmdDispatcher/LLCmdDispatcherComponentAc.hpp>
...
namespace LLProc {
  ...
  //! \class LLCmdDispatcherTesterBase
  //! \brief Auto-generated base class for LLCmdDispatcher component test harness
  //!
  class LLCmdDispatcherTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object LLCmdDispatcherTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object LLCmdDispatcherTesterBase
      //!
      ...
      //! Destroy object LLCmdDispatcherTesterBase
      //!
      virtual ~LLCmdDispatcherTesterBase(void);
    ...
    protected:
      ...
      virtual void logIn_WARNING_HI_OpCodeError(
          ...
          LLCmdDispatcherComponentBase::ErrorResponse error /*!< The error value*/
      );
    ...
    protected:
      ...
      virtual void logIn_WARNING_HI_MalformedCommand(
          LLCmdDispatcherComponentBase::CmdSerError Status /*!< The deserialization error*/
      );
