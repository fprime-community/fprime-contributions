// ======================================================================
// \title  LLTlmChan/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for LLTlmChan component test harness base class
//
// \copyright
...
#ifndef LLTlmChan_TESTER_BASE_HPP
#define LLTlmChan_TESTER_BASE_HPP
...
namespace LLProc {
  ...
  //! \class LLTlmChanTesterBase
  //! \brief Auto-generated base class for LLTlmChan component test harness
  //!
  class LLTlmChanTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object LLTlmChanTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object LLTlmChanTesterBase
      //!
      LLTlmChanTesterBase(
      ...
      //! Destroy object LLTlmChanTesterBase
      //!
      virtual ~LLTlmChanTesterBase(void);
