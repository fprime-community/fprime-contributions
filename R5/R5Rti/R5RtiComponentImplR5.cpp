...
#include <R5/TiHal/include/HL_reg_rti.h>
#include "rtiDefs.h"
...
namespace R5 {
  ...
  {
    if (rtiREG1->INTFLAG & RTI_INTFLAG_INT0) {
        alreadySet = true;
    } else {
        alreadySet = false;

        while (!(rtiREG1->INTFLAG & RTI_INTFLAG_INT0))
        {}
    }

    rtiREG1->INTFLAG = RTI_INTFLAG_INT0;
  }
