// ====================================================================== 
// \title  BlspGpioDriver.hpp
// \author tcanham
// \brief  cpp file for BlspGpioDriver test harness implementation class
//
// \copyright
...
namespace SnapdragonFlight {
  ...
  Tester ::
    Tester(void) : 
      ...
      BlspGpioDriverTesterBase("Tester", MAX_HISTORY_SIZE),
      component("GP")
#else
      BlspGpioDriverTesterBase(MAX_HISTORY_SIZE),
      component()
#endif
      ,m_cycles(0)
      ,m_currCycle(0)
    ...
    testInterrrupt(NATIVE_INT_TYPE gpio, NATIVE_INT_TYPE cycles)
  {
      ...
      if (not this->component.open(gpio,BlspGpioDriverComponentImpl::GPIO_INT)) {
          return;
      }
  ...
  void Tester ::
    testOutput(NATIVE_INT_TYPE gpio, NATIVE_INT_TYPE cycles) {
      ...
      this->component.open(gpio,BlspGpioDriverComponentImpl::GPIO_OUT);
  ...
  void Tester ::
    testInput(NATIVE_INT_TYPE gpio, NATIVE_INT_TYPE cycles) {
      ...
      this->component.open(gpio,BlspGpioDriverComponentImpl::GPIO_IN);
