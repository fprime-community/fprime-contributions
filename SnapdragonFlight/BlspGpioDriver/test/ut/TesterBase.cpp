// ======================================================================
// \title  BlspGpioDriver/test/ut/TesterBase.cpp
// \author Auto-generated
// \brief  cpp file for BlspGpioDriver component test harness base class
//
// \copyright
...
namespace SnapdragonFlight {
  ...
  NATIVE_INT_TYPE BlspGpioDriverTesterBase ::
  ...
  Svc::InputCyclePort *BlspGpioDriverTesterBase ::
  ...
  Fw::InputTimePort *BlspGpioDriverTesterBase ::
  ...
  Fw::InputLogPort *BlspGpioDriverTesterBase ::
...
#if FW_ENABLE_TEXT_LOGGING == 1
  Fw::InputLogTextPort *BlspGpioDriverTesterBase ::
  ...
  {
    FW_ASSERT(callComp);
    BlspGpioDriverTesterBase* _testerBase = 
      static_cast<BlspGpioDriverTesterBase*>(callComp);
  ...
  {
    BlspGpioDriverTesterBase* _testerBase =
      static_cast<BlspGpioDriverTesterBase*>(component);
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case BlspGpioDriverComponentBase::EVENTID_GP_OPENERROR: 
      {
      ...
      case BlspGpioDriverComponentBase::EVENTID_GP_CONFIGERROR: 
      {
      ...
      case BlspGpioDriverComponentBase::EVENTID_GP_WRITEERROR: 
      {
      ...
      case BlspGpioDriverComponentBase::EVENTID_GP_READERROR: 
      {
      ...
      case BlspGpioDriverComponentBase::EVENTID_GP_PORTOPENED: 
      {
      ...
      case BlspGpioDriverComponentBase::EVENTID_GP_INTSTARTERROR: 
      {
      ...
      case BlspGpioDriverComponentBase::EVENTID_GP_INTWAITERROR: 
      {
