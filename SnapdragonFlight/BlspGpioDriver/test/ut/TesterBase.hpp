// ======================================================================
// \title  BlspGpioDriver/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for BlspGpioDriver component test harness base class
//
// \copyright
...
#ifndef BlspGpioDriver_TESTER_BASE_HPP
#define BlspGpioDriver_TESTER_BASE_HPP
...
namespace SnapdragonFlight {
  ...
  //! \class BlspGpioDriverTesterBase
  //! \brief Auto-generated base class for BlspGpioDriver component test harness
  //!
  class BlspGpioDriverTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object BlspGpioDriverTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object BlspGpioDriverTesterBase
      //!
      ...
      //! Destroy object BlspGpioDriverTesterBase
      //!
      virtual ~BlspGpioDriverTesterBase(void);
