// ======================================================================
// \title  BlspSerialDriver/test/ut/GTestBase.hpp
// \author Auto-generated
// \brief  hpp file for BlspSerialDriver component Google Test harness base class
//
// \copyright
...
#ifndef BlspSerialDriver_GTEST_BASE_HPP
#define BlspSerialDriver_GTEST_BASE_HPP
...
namespace SnapdragonFlight {
  ...
  //! \class BlspSerialDriverGTestBase
  //! \brief Auto-generated base class for BlspSerialDriver component Google Test harness
  //!
  class BlspSerialDriverGTestBase :
    public BlspSerialDriverTesterBase
  {
    ...
    protected:
      ...
      //! Construct object BlspSerialDriverGTestBase
      //!
      ...
      //! Destroy object BlspSerialDriverGTestBase
      //!
      virtual ~BlspSerialDriverGTestBase(void);
