// ======================================================================
// \title  BlspSerialDriver/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for BlspSerialDriver component test harness base class
//
// \copyright
...
#ifndef BlspSerialDriver_TESTER_BASE_HPP
#define BlspSerialDriver_TESTER_BASE_HPP
...
namespace SnapdragonFlight {
  ...
  //! \class BlspSerialDriverTesterBase
  //! \brief Auto-generated base class for BlspSerialDriver component test harness
  //!
  class BlspSerialDriverTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object BlspSerialDriverTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object BlspSerialDriverTesterBase
      //!
      ...
      //! Destroy object BlspSerialDriverTesterBase
      //!
      virtual ~BlspSerialDriverTesterBase(void);
