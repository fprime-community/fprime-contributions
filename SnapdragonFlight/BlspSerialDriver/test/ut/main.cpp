...
void run_simple_test(SnapdragonFlight::Tester& tester)
{
...
void run_ramping_pattern_test(SnapdragonFlight::Tester& tester)
{
    BYTE pattern[256];
...
void run_router_test(SnapdragonFlight::Tester& tester)
{
...
int main(int argc, char **argv) {
    ...
    SnapdragonFlight::Tester tester(device,20,READ_BUFF_SIZE,
				    SnapdragonFlight::BlspSerialDriverComponentImpl::HW_FLOW);
