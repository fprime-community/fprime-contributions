// ======================================================================
// \title  BlspSpiDriver/test/ut/TesterBase.cpp
// \author Auto-generated
// \brief  cpp file for BlspSpiDriver component test harness base class
//
// \copyright
...
namespace SnapdragonFlight {
  ...
  NATIVE_INT_TYPE BlspSpiDriverTesterBase ::
  ...
  Fw::InputTlmPort *BlspSpiDriverTesterBase ::
  ...
  Fw::InputTimePort *BlspSpiDriverTesterBase ::
  ...
  Fw::InputLogPort *BlspSpiDriverTesterBase ::
...
#if FW_ENABLE_TEXT_LOGGING == 1
  Fw::InputLogTextPort *BlspSpiDriverTesterBase ::
  ...
  {
    BlspSpiDriverTesterBase* _testerBase =
      static_cast<BlspSpiDriverTesterBase*>(component);
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case BlspSpiDriverComponentBase::CHANNELID_SPI_BYTES:
      {
        U32 arg;
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case BlspSpiDriverComponentBase::EVENTID_SPI_OPENERROR: 
      {
        ...
        this->logIn_WARNING_HI_SPI_OpenError(device, error);

        break;

      }

      case BlspSpiDriverComponentBase::EVENTID_SPI_CONFIGERROR: 
      {
        ...
        this->logIn_WARNING_HI_SPI_ConfigError(device, error);

        break;

      }

      case BlspSpiDriverComponentBase::EVENTID_SPI_WRITEERROR: 
      {
        ...
        this->logIn_WARNING_HI_SPI_WriteError(device, error);

        break;

      }

      case BlspSpiDriverComponentBase::EVENTID_SPI_PORTOPENED: 
      {
        ...
        this->logIn_ACTIVITY_HI_SPI_PortOpened(device);
