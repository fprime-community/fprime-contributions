// ======================================================================
// \title  BlspSpiDriver/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for BlspSpiDriver component test harness base class
//
// \copyright
...
#ifndef BlspSpiDriver_TESTER_BASE_HPP
#define BlspSpiDriver_TESTER_BASE_HPP
...
namespace SnapdragonFlight {
  ...
  //! \class BlspSpiDriverTesterBase
  //! \brief Auto-generated base class for BlspSpiDriver component test harness
  //!
  class BlspSpiDriverTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object BlspSpiDriverTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object BlspSpiDriverTesterBase
      //!
      ...
      //! Destroy object BlspSpiDriverTesterBase
      //!
      virtual ~BlspSpiDriverTesterBase(void);
