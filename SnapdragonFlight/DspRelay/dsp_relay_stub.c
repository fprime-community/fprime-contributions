...
static const Method* const methodArrays[28] = {&(methods[0]),&(methods[1]),&(methods[1]),&(methods[2]),&(methods[2]),&(methods[1]),&(methods[2]),&(methods[2]),&(methods[2]),&(methods[1]),&(methods[3]),&(methods[4]),&(methods[5]),&(methods[2]),&(methods[1]),&(methods[2]),&(methods[1]),&(methods[2]),&(methods[6]),&(methods[1]),&(methods[1]),&(methods[7]),&(methods[6]),&(methods[1]),&(methods[1]),&(methods[8]),&(methods[9]),&(methods[1])};
...
static const uint16_t methodStrings[86] = {85,682,621,662,614,569,564,520,640,148,682,607,591,331,168,682,574,544,599,228,607,22,583,43,682,533,554,64,682,533,554,264,682,621,657,395,621,657,634,188,682,628,0,621,652,247,682,621,427,672,682,208,672,682,106,672,682,281,682,646,127,682,667,315,682,475,621,347,682,490,621,363,682,505,621,379,621,411,621,443,682,298,682,459,672,677};
static const uint16_t methodStringsArrays[28] = {85,83,81,60,57,79,54,51,48,77,0,35,31,45,75,42,73,39,27,71,69,14,23,67,65,9,19,63};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_quit)(int gpio, int fd) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 8;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&gpio, (uint32_t*)&fd);
}
